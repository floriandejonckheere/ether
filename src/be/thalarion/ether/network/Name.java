 ...
 * Names generator
 * 
 * Modified from docker/pkg/namesgenerator/names-generator.go
...
public class Name {
    ...
    public static String generate() {
        ...
        String l = left[random.nextInt(left.length)];
        String r = right[random.nextInt(right.length)];
        
        return String.format("%s%s %s%s",
                Character.toUpperCase(l.charAt(0)),
                l.substring(1),
                
                Character.toUpperCase(r.charAt(0)),
                r.substring(1)
        );
    }
